...
int main()
{
	...
	//Where is the mouse in relation to screen coortdinates
	...
	int clipSize = 6;
	float fireRate = 1;
	//When was the fire buttom last pressed?
	Time lastPressed;
	...
	while (window.isOpen())
	{
		...
		************************/
		...
		if (state == State::LEVELING_UP)
		{
			...
			//Handle the playing LEVELING up
			...
			if (state == State::PLAYING)
			{
				...
				//Delete the previously allowcated memory (if it exists)
				delete[] zombies;
